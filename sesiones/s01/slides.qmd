...
- Archivos de datos para las actividades
- Enunciados de las tareas

Ábrelo ahora en tu teléfono o computador.
:::

::: {.column width="45%" style="text-align: center;"}
![](../../imagenes/qr-code.svg){width="240px" style="margin-bottom: 0.2em;"}

[jdleongomez.github.io/curso-r]{style="color: rgba(255,255,255,0.7); font-size: 0.6em; letter-spacing: 0.03em;"}
:::
:::::
