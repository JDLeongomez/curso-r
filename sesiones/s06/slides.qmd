...
::: tip-box
Cada vez que los datos cambian, cada valor copiado a mano es un error potencial.
:::
:::
:::::
...
::: tip-box
Si ves un archivo `.Rmd` (que significa "R Markdown"), puedes leerlo sin problema: la estructura es casi idéntica. Para trabajo nuevo, usa siempre Quarto (`.qmd` que significa "Quarto Markdown").
:::
...
<div style="font-size:0.9em; line-height:1.9;">
  <h1 style="font-size:1.1em; margin:0.2em 0 0.1em; padding:0; border:none;">Título principal</h1>
  <h2 style="font-size:0.95em; margin:0.2em 0 0.1em; padding:0; border:none;">Sección</h2>
...
## Tarea 2: presenta un paquete de R {.smaller}
...
[→ Instrucciones completas y ejemplos de inspiración](../../tareas/tarea2-paquete-raro.html)
:::
