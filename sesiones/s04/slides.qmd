...
5. Descarga estos archivos y ponlos en la carpeta `datos/` del proyecto:
   - [⬇ `encuesta_bruta.xlsx`](https://github.com/JDLeongomez/curso-r/raw/main/sesiones/s03/datos/encuesta_bruta.xlsx){style="color:#ffd88a;"} (Sesión 3)
   - [⬇ `notas.csv`](https://github.com/JDLeongomez/curso-r/raw/main/sesiones/s04/datos/notas.csv){style="color:#ffd88a;"}
   - [⬇ `registro.xlsx`](https://github.com/JDLeongomez/curso-r/raw/main/sesiones/s04/datos/registro.xlsx){style="color:#ffd88a;"}
::::
:::
...
::: actividad-desc
[⬇ Descargar `notas.csv`](https://github.com/JDLeongomez/curso-r/raw/main/sesiones/s04/datos/notas.csv){style="color:#ffd88a;"} (si no lo has hecho)
...
::: actividad-desc
[⬇ Descargar `registro.xlsx`](https://github.com/JDLeongomez/curso-r/raw/main/sesiones/s04/datos/registro.xlsx){style="color:#ffd88a;"} (si no lo has hecho)
...
::: tip-box
Si no tienes un archivo propio, usa [⬇ `encuesta_bruta.xlsx` de la Sesión 3](https://github.com/JDLeongomez/curso-r/raw/main/sesiones/s03/datos/encuesta_bruta.xlsx){style="color:#ffd88a;"} desde tu proyecto nuevo y verifica que la ruta relativa funciona sin modificar el código.
:::
