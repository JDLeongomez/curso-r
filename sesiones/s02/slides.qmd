---
title: "Sesión 2"
subtitle: "Visualizaciones con ggplot2"
...
## El universo tidyverse {.smaller}

::::: columns
::: {.column width="34%"}

<img src="../../imagenes/tidyverse.png" style="width:120px; display:block; margin:0 auto 0.6em;" />
...
```{=html}
<div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:0.55em; font-size:0.82em;">

  <div style="display:flex; align-items:center; gap:0.5em;">
    <img src="../../imagenes/ggplot2.png" style="width:48px; flex-shrink:0;" />
    <div><div style="font-weight:700;">ggplot2</div><div style="color:#555; font-size:0.88em;">Visualización de datos</div></div>
  </div>

  <div style="display:flex; align-items:center; gap:0.5em;">
    <img src="../../imagenes/dplyr.png" style="width:48px; flex-shrink:0;" />
    <div><div style="font-weight:700;">dplyr</div><div style="color:#555; font-size:0.88em;">Manipulación de datos</div></div>
  </div>

  <div style="display:flex; align-items:center; gap:0.5em;">
    <img src="../../imagenes/readr.png" style="width:48px; flex-shrink:0;" />
    <div><div style="font-weight:700;">readr</div><div style="color:#555; font-size:0.88em;">Importar archivos CSV</div></div>
  </div>

  <div style="display:flex; align-items:center; gap:0.5em;">
    <img src="../../imagenes/tidyr.png" style="width:48px; flex-shrink:0;" />
    <div><div style="font-weight:700;">tidyr</div><div style="color:#555; font-size:0.88em;">Reorganizar y pivotar tablas</div></div>
  </div>

  <div style="display:flex; align-items:center; gap:0.5em;">
    <img src="../../imagenes/purrr.png" style="width:48px; flex-shrink:0;" />
    <div><div style="font-weight:700;">purrr</div><div style="color:#555; font-size:0.88em;">Programación funcional</div></div>
  </div>

  <div style="display:flex; align-items:center; gap:0.5em;">
    <img src="../../imagenes/tibble.png" style="width:48px; flex-shrink:0;" />
    <div><div style="font-weight:700;">tibble</div><div style="color:#555; font-size:0.88em;">Marcos de datos modernos</div></div>
  </div>

  <div style="display:flex; align-items:center; gap:0.5em;">
    <img src="../../imagenes/stringr.png" style="width:48px; flex-shrink:0;" />
    <div><div style="font-weight:700;">stringr</div><div style="color:#555; font-size:0.88em;">Manipulación de texto</div></div>
  </div>

  <div style="display:flex; align-items:center; gap:0.5em;">
    <img src="../../imagenes/forcats.png" style="width:48px; flex-shrink:0;" />
    <div><div style="font-weight:700;">forcats</div><div style="color:#555; font-size:0.88em;">Manejo de factores</div></div>
  </div>

  <div style="display:flex; align-items:center; gap:0.5em;">
    <img src="../../imagenes/lubridate.png" style="width:48px; flex-shrink:0;" />
    <div><div style="font-weight:700;">lubridate</div><div style="color:#555; font-size:0.88em;">Fechas y horas</div></div>
  </div>
