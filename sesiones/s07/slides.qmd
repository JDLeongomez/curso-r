...
::: tip-box
`kable()` tiene muchas opciones adicionales, y en compañia del paquete `kableExtra` permite hacer tablas complejas tanto en [HTML](https://haozhu233.github.io/kableExtra/awesome_table_in_html.html) como en [LaTeX](https://haozhu233.github.io/kableExtra/awesome_table_in_pdf.pdf) (PDF). Sin embargo, en esta sesión nos centraremos en `gt`.
:::
...
::: tip-box
`gt` tiene muchas opciones adicionales. Puedes explorarlas en la [documentación oficial](https://gt.rstudio.com/articles/gt.html).
:::
...
Como se observa en la [Tabla 1]{style="color:#225faa; text-decoration:underline;"}, la especie Gentoo tiene la mayor masa corporal.
:::
::: {.column width="48%"}
::: tip-box
...
2. Un tema HTML distinto al defecto (prueba `cosmo`, `flatly` o [cualquier otro](https://quarto.org/docs/output-formats/html-themes.html))
